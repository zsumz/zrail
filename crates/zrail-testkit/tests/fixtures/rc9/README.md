...
- `assertions.json` records 381 reviewed assertion instances, including separately
  ...
  verification states. Its 134 open assertion IDs are release blockers, alongside
