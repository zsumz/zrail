...
- `assertions.json` records 559 reviewed assertion instances, including separately
  ...
  verification states. Its 75 open assertion IDs are release blockers, alongside
  the unfinished discovery work; 484 instances have verified replacement evidence.
