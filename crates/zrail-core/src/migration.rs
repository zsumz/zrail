...
const SUPPORTED_PRIOR_EPOCHS: &[(u64, u64)] = &[(1, 1), (1, 2), (2, 3), (3, 4), (3, 5), (3, 6)];
...
fn compare_epochs(
        ...
        || after.semantics != LOCK_SEMANTICS
    {
        return Err(LockMigrationError(format!(
            "lock migration supports released epochs schema 1/semantics 1, schema 1/semantics 2, schema 2/semantics 3, schema 3/semantics 4, schema 3/semantics 5, and schema 3/semantics 6 to schema {LOCK_SCHEMA}/semantics {LOCK_SEMANTICS}"
        )));
    }
