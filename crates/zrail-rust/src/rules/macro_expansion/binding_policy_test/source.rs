//! Minimal source facts isolate macro authority from unrelated source policies.

use crate::{
    inventory::FileClass,
    source::{
        MacroExpansionFact, Reachability, ReachabilityKind, RustFileFacts, SourceAnalysisMetrics,
        SourceIndex, SourceSyntax,
    },
};

pub(super) fn source(expansion: MacroExpansionFact) -> SourceIndex {
    SourceIndex {
