...
pub(crate) use super::{
    ...
    model::{
        ...
        ObservedFact, ProjectionIdentity, ProviderAuthority, RootLookupNamespace, RustFileFacts,
        SourceIndex, SourceSyntax, SyntaxGuard, TraitBoundFact, generic_root_identity,
