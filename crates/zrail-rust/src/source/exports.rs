...
pub(crate) use super::{
    ...
    model::{
        ...
        CallResolutionFact, CallResolutionKind, ConstructorForm, FactNamespace,
        GenericAssociatedCandidate, GenericParameterBounds, GenericRootIdentity, GenericRootShadow,
        GuardAvailability, ImplicitPreludeEligibility, ImportBindingFact, IncludeBoundary,
        IncludeContext, LexicalSelfIdentity, MacroImportFact, ModuleBinding, ModuleDeclaration,
        ObservedFact, RootLookupNamespace, RustFileFacts, SourceIndex, SourceSyntax, SyntaxGuard,
