...
pub(crate) use super::{
    ...
    model::{
        AssociatedOccurrenceKind, AsyncSyntaxFact, BindingAnchor, BindingKind, BindingVisibility,
        BoundSubject, CallResolutionFact, CallResolutionKind, ConstructorForm, FactNamespace,
        GenericAssociatedCandidate, GenericRootIdentity, GenericRootShadow, GuardAvailability,
        ImplicitPreludeEligibility, ImportBindingFact, IncludeBoundary, IncludeContext,
        LexicalSelfIdentity, MacroImportFact, ModuleBinding, ModuleDeclaration, ObservedFact,
        ProviderAuthority, RootLookupNamespace, RustFileFacts, SourceIndex, SourceSyntax,
        SyntaxGuard, TraitBoundFact, generic_root_identity, generic_root_shadow,
        identity_for_generic_root,
    },
