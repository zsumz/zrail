...
const HELP: &str = concat!(
    ...
    "  zrail check [--root ROOT] [--format human|json] [--limit N|all]\n",
    ...
    "  zrail doctor [--root ROOT] [--format human|json] [--limit N|all]\n",
    "  zrail explain --path PATH [--root ROOT] [--format human|json] [--limit N|all]\n",
    "  zrail review [--base REVISION] [--authority-root ROOT] --root PROPOSAL [--allow-grants] [--limit N|all]\n",
