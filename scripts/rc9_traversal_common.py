...
SUITES = {
    ...
    "traversal_roots_empty_trees_and_selection_are_explicit": (False, "portable-physical", 48),
    ...
    "qualify_frozen_source_traversal": (True, "frozen-selection-and-complete-matrix", 229),
}
