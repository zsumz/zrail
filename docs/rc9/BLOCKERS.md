...
| `KD-TRANSPORT-DETECTOR-METHODS` | Native authored quantities and strict file parsing are implemented; exact frozen production selection and the original detector fixture still need bound differential qualification. |
...
| `KD-TRANSPORT-METHODS` | Native authored quantities and strict file parsing are implemented; exact frozen production selection and the original detector fixture still need bound differential qualification. |
