...
| `KD-TRANSPORT-DETECTOR-OWNERS` | Native written-path membership and exact owner sets are implemented with frozen syntax-context comparisons. Full frozen-scope differential fixtures and reproducible bound evidence remain required before verification. |
...
| `KD-TRANSPORT-OWNERS` | Native written-path membership and exact owner sets are implemented with frozen syntax-context comparisons. Full frozen-scope differential fixtures and reproducible bound evidence remain required before verification. |
